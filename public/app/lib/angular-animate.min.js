...
(function(S, q) {
    ...
    function W(a, b, c) {
        ...
        t(a, function(a, f) { a && 0 < a.length && (d += 0 < f ? " " : "", d += c ? b + a : a + b) });
        return d
    }
    ...
    q.module("ngAnimate", [], function() {
        ...
        Da = q.isFunction;
        Z = q.isElement
    }).info({ angularVersion: "1.6.7" }).directive("ngAnimateSwap", ["$animate", "$rootScope", function(a, b) {
        return {
            restrict: "A",
            transclude: "element",
            terminal: !0,
        ...
        this.$get = ["$$rAF", "$rootScope", "$rootElement", "$document", "$$Map", "$$animation", "$$AnimateRunner", "$templateRequest", "$$jqLite", "$$forceReflow", "$$isDocumentHidden", function(b, c, f, s, y, sa, da, v, E, g, M) {
            ...
            function L(a, b, c) {
                ...
                for ((a = A.data(a, "$ngAnimatePin")) && (b = J(a)); b;) {
                    ...
                    if (!g) {
                        var H = ga.get(b);
                        if (!0 === H && !1 !== e) { e = !0; break } else !1 === H && (e = !1);
                        g = a.structural
                    }
                    ...
                    k || (k = b === c);
                    if (k && d) break;
                    if (!d && (a = A.data(b, "$ngAnimatePin"))) { b = J(a); continue }
                    b = b.parentNode
                }
                return (!g || p) && !0 !== e && d && k
            }
        ...
        this.$get = ["$$jqLite", "$rootScope", "$injector", "$$AnimateRunner", "$$Map", "$$rAFScheduler", function(a, d, e, f, n, G) {
            function l(a) {
                function b(a) {
                    ...
                    g.set(d, a);
                    for (var f; e;) {
                        if (f = g.get(e)) { f.processed || (f = b(f)); break }
                        e = e.parentNode
                    }(f || c).children.push(a);
                    return a
                }
        ...
        this.$get = ["$window", "$$jqLite", "$$AnimateRunner", "$timeout", "$$forceReflow", "$sniffer", "$$rAFScheduler", "$$animateQueue", function(a, e, f, n, G, l, s, y) {
            ...
            return function(a, c) {
                ...
                function F() {
                    ...
                    v(O);
                    m();
                    return { $$willAnimate: !1, start: function() { return A }, end: d }
                }
        ...
        this.$get = ["$animateCss", "$rootScope", "$$AnimateRunner", "$rootElement", "$sniffer", "$$jqLite", "$document", function(a, c, d, e, f, n, G) {
            ...
            function q(a, b, c, f) {
                ...
                if (e || l || 0 !== n.length) return {
                    start: function() {
                        function a() { t(b, function(a) { a.end() }) }
                        var b = [];
                        e && b.push(e.start());
                        l && b.push(l.start());
                        t(n, function(a) { b.push(a.start()) });
            ...
            return function(a, b, d, s) {
                ...
                function v(a, b, d, e, f) {
                    ...
                    if (0 !== g.length) return function(a) {
                        ...
                        return function(a) { t(b, function(b) { a ? b.cancel() : b.end() }) }
                    }
                }
                var E = !1;
