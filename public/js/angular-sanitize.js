...
(function(s, d) {
    ...
    d.module("ngSanitize", []).provider("$sanitize", function() {
        ...
        function t(a, e) { var c = e[a]; if (c && F.call(e, c)) throw x("elclob", e.outerHTML || e.outerText); return c }
        var y = !1;
        this.$get = ["$$sanitizeUri", function(a) {
            y && k(n, z);
            return function(e) {
                var c = [];
                G(e, w(c, function(b, c) { return !/^unsafe:/.test(a(b, c)) }));
                return c.join("")
            }
        }];
        this.enableSvg = function(a) { return E(a) ? (y = a, this) : y };
        C = d.bind;
        k = d.extend;
        D = d.forEach;
        E = d.isDefined;
        ...
        G = function(a, e) {
            ...
            for (b = c.firstChild; b;) {
                ...
                var f;
                if (!(f = b.firstChild) && (1 === b.nodeType && e.end(b.nodeName.toLowerCase()), f = t("nextSibling", b), !f))
                    for (; null == f;) {
                        b = t("parentNode", b);
                        if (b === c) break;
                        f = t("nextSibling", b);
        ...
        var L = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
            ...
            u = function(a, e) {
                ...
                var h;
                if (e && e.implementation) h = e.implementation.createHTMLDocument("inert");
                ...
                return d.querySelector("svg") ?
                    (d.innerHTML = '<svg><p><style><img src="</style><img src=x onerror=alert(1)//">', d.querySelector("svg img") ? c : b) : function(b) {
                        b = "<remove></remove>" + b;
                        try { b = encodeURI(b) } catch (c) { return }
    ...
    d.module("ngSanitize").filter("linky", ["$sanitize", function(g) {
        ...
        return function(d, q, l) {
            ...
            for (var A = y(l) ? l : w(l) ? function() { return l } : function() { return {} }, n = d, m = [], v, u; d = n.match(k);) v = d[0], d[2] ||
